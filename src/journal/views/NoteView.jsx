    ...
    <Grid container direction='row' 
        ...
        <Grid item>
            ...
            <IconButton
                color='primary'
                disabled= { isSaving }
                onClick={ () => fileInputRef.current.click() } // De este modo hago referencia al input que tengo arriba
            >
                <UploadOutlined />
            </IconButton>
        ...
        <ImageGallery images={ note.imageUrls } /> /* Se refiere a la note:active*/
